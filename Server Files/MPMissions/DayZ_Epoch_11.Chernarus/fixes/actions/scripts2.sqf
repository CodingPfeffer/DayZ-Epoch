...
_role1 = "Scripts";		 //you can change all in ""
_role1names = ["AI","Trader Safezone","Missions","Lift- und Towing","Debug Monitor","Selfblood","Suicide","Burry NPCs","Grave Cross","Salvage vehicles","and more"];  
{
sleep 2;
