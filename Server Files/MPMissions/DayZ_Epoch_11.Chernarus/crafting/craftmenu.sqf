...
manatee_craft_menu set [count manatee_craft_menu, player addaction [("<t color=""#4AC925"">" + ("  Tools") +"</t>"),"crafting\tools.sqf","",91,false,false,"",_restriction]];
manatee_craft_menu set [count manatee_craft_menu, player addaction [("<t color=""#0074E8"">" + ("-----------------------------") +"</t>"),"","",89,false,false,"",_restriction]];