...
if (SAR_dynamic_spawning) then {
    ...
    // Kamenka, 0 bandit groups, 1 soldier groups, 2 survivor groups - spawn probability ba,so,su - maximum group members ba,so,su
    [["max_grps","rnd_grps","max_p_grp"],[[2,0,2],[0,100,100],[0,2,1]],"SAR_area_0_0"] call SAR_AI_mon_upd; 
...
_this = createMarker ["SAR_patrol_zone_s_1", [1842,12226]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
SAR_patrol_zone_s_1 = _this;

// Golden Town 1 Ebene
_this = createMarker ["SAR_patrol_zone_s_2", [1991,12147]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
SAR_patrol_zone_s_2 = _this;

// Golden Town 2 Ebene
_this = createMarker ["SAR_patrol_zone_s_3", [1971,12289]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
SAR_patrol_zone_s_3 = _this;


// Golden Town 3 Ebene
_this = createMarker ["SAR_patrol_zone_s_4", [2021,12240]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
SAR_patrol_zone_s_4 = _this;

// Golden Town 4 Ebene
_this = createMarker ["SAR_patrol_zone_s_5", [2020,12229]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
SAR_patrol_zone_s_5 = _this;


//Miene eingang
_this = createMarker ["SAR_patrol_zone_m_1", [2096,12773]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
SAR_patrol_zone_m_1 = _this;


//Miene
_this = createMarker ["SAR_patrol_zone_m_2", [2114,12776]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
SAR_patrol_zone_m_2 = _this;


//Miene
_this = createMarker ["SAR_patrol_zone_m_3", [2143,12835]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
SAR_patrol_zone_m_3 = _this;

//Miene
_this = createMarker ["SAR_patrol_zone_m_4", [2173,12857]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [50, 50];
SAR_patrol_zone_m_4 = _this;
...
//Sector FNG Stuff
[SAR_marker_sectorfng_front,3,0,15,"fortify",true,900] call SAR_AI;
[SAR_marker_sectorfng_back,3,0,15,"fortify",true,900] call SAR_AI;
[SAR_marker_sectorfng_crate1,3,1,4,"fortify",true,900] call SAR_AI;
[SAR_marker_sectorfng_crate2,3,1,4,"fortify",true,900] call SAR_AI;
[SAR_marker_sectorfng_crate3,1,1,4,"fortify",true,900] call SAR_AI;
[SAR_marker_sectorfng_crate4,3,1,4,"fortify",true,900] call SAR_AI;
[SAR_marker_sectorfng_crate5,3,1,4,"fortify",true,900] call SAR_AI;
*/
...
// Golden Town
[SAR_patrol_zone_s_1,3,4,8,"fortify",true,3600] call SAR_AI;
[SAR_patrol_zone_s_2,3,4,8,"fortify",true,3600] call SAR_AI;
[SAR_patrol_zone_s_3,3,4,4,"fortify",true,3600] call SAR_AI;
[SAR_patrol_zone_s_4,3,6,4,"fortify",true,3600] call SAR_AI;
[SAR_patrol_zone_s_5,3,4,2,"fortify",true,3600] call SAR_AI;

//Miene
[SAR_patrol_zone_m_1,3,4,4,"fortify",true,3600] call SAR_AI;
[SAR_patrol_zone_m_2,3,4,4,"fortify",true,3600] call SAR_AI;
[SAR_patrol_zone_m_3,3,4,4,"fortify",true,3600] call SAR_AI;
[SAR_patrol_zone_m_4,3,4,4,"fortify",true,3600] call SAR_AI;
