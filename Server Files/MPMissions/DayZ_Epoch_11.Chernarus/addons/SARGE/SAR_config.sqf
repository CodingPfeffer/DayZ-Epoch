...
SAR_DESPAWN_TIMEOUT = 300; // 2 minutes

// time after which dead AI bodies are deleted 
SAR_DELETE_TIMEOUT = 1800; // 2 minutes
...
// potential weapon list for leaders
SAR_band_leader_weapon_list = ["M4A1","M4A3_CCO_EP1","AK_47_M","M240_DZ"];
...
//potential weapon list for snipers
SAR_band_sniper_weapon_list = ["M4A1_Aim","SVD_CAMO","Huntingrifle","DMR","M24"];
