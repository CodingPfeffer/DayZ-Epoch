...
// AMMUNITION
_crate addMagazineCargoGlobal ["15Rnd_9x19_M9", 5];
_crate addMagazineCargoGlobal ["15Rnd_9x19_M9SD", 5];
...
_crate addMagazineCargoGlobal ["1Rnd_HE_GP25", 2];
_crate addMagazineCargoGlobal ["1Rnd_SMOKE_GP25", 5];
...
_crate addMagazineCargoGlobal ["30Rnd_556x45_G36SD", 5];
_crate addMagazineCargoGlobal ["30Rnd_556x45_Stanag", 5];
_crate addMagazineCargoGlobal ["30Rnd_556x45_StanagSD", 5];
_crate addMagazineCargoGlobal ["5x_22_LR_17_HMR", 5];
_crate addMagazineCargoGlobal ["10x_303", 5];
_crate addMagazineCargoGlobal ["20Rnd_762x51_B_SCAR", 5];
_crate addMagazineCargoGlobal ["20Rnd_762x51_SB_SCAR", 5];
_crate addMagazineCargoGlobal ["5Rnd_762x51_M24", 85];
_crate addMagazineCargoGlobal ["15Rnd_9x19_M9SD", 5];
_crate addMagazineCargoGlobal ["17Rnd_9x19_glock17", 5];
_crate addMagazineCargoGlobal ["30Rnd_9x19_MP5", 5];
_crate addMagazineCargoGlobal ["30Rnd_9x19_MP5SD", 5];
_crate addMagazineCargoGlobal ["30Rnd_9x19_UZI", 5];
_crate addMagazineCargoGlobal ["100Rnd_762x54_PK", 3];
_crate addMagazineCargoGlobal ["75Rnd_545x39_RPK", 5];
_crate addMagazineCargoGlobal ["8Rnd_B_Saiga12_74Slug", 5];
_crate addMagazineCargoGlobal ["8Rnd_B_Saiga12_Pellets", 5];
_crate addMagazineCargoGlobal ["10Rnd_762x54_SVD", 5];
_crate addMagazineCargoGlobal ["10Rnd_9x39_SP5_VSS", 5];
